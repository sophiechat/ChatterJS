...
MessagePrinter.prototype.removeWritingDiv = function () {
    if (document.getElementById("writingDiv") != undefined) {
        //Alterado para contemplar o navegador IE11
        var element = document.getElementById("writingDiv");
...
MessagePrinter.prototype.createMessageBox = function (align, image, who, systemName, text, suggestions, time) {
    ...
    child3.innerHTML = "<p " + (who == systemName ? "class='bot-name'" : "class='user-name'") + ">" + who + "</p> <p>"+ text +"</p>";
	...
	if(align == 'left'){
        ...
        //child4.appendChild(this.createPicture("avatar01.png"));
...
MessagePrinter.prototype.createPicture = function (image) {
    ...
    element.setAttribute('src', contentDir + "images/" + image);
