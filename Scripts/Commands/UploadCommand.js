...
UploadCommand.prototype.execute = function () {    
    ...
    for (var i = 0; i < this.responseText.length; i++) {
        ...
        htmlUpload += '<input class=\"btn btn-info mr10 mb10\" type=\"button\" id=\"btSelectFiles' + lastUploadsControls + '\" ' + (multiple ? 'value=\"' + translation[this.userLang]['selectFiles'] + '\"' : 'value=\"' + translation[this.userLang]['selectFile'] + '\"') + '\" onclick=\"javascript:if(checkActualControl(' + lastUploadsControls + ')) userFile' + lastUploadsControls + '.click(); \" >'
        ...
        htmlUpload += '<input class=\"btn btn-info mr10 mb10\" id=\"formsubmit' + lastUploadsControls + '\" type=\"submit\" onclick=\"uploadFiles(' + lastUploadsControls + '); return false;\"' + (multiple ? 'value=\"' + translation[this.userLang]['sendFiles'] + '\"' : 'value=\"' + translation[this.userLang]['sendFile'] + '\"') + ' />';
        ...
        htmlUpload += '<input class=\"btn btn-danger mr10 mb10\" id=\"btNotSend' + lastUploadsControls + '\" type=\"button\" onclick=\"notSend(' + lastUploadsControls + ');\" value=\"' + translation[this.userLang]['cancel'] + '\" />';
